...
export default function IITProjects() {
  ...
  const tradingFeatures = [
    { icon: <TrendingUp size={22} color="#60A5FA" strokeWidth={1.8} />, title: "Rule-Based Algorithmic Trading System", desc: "Advanced trading strategies powered by data-driven rules" },
    { icon: <Database size={22} color="#60A5FA" strokeWidth={1.8} />, title: "Real Market Data Analysis", desc: "Live market data integration and analysis" },
    { icon: <Code2 size={22} color="#60A5FA" strokeWidth={1.8} />, title: "Python Backtesting Framework", desc: "Comprehensive backtesting and validation system" },
    { icon: <Brain size={22} color="#60A5FA" strokeWidth={1.8} />, title: "AI-Driven Trading Intelligence", desc: "Machine learning for predictive trading insights" },
  ];
